...
def test_for_mainNavbar(browser):
    browser.find_element(By.ID, "cart").click()

def test_find_search(browser):
    browser.find_element(By.CLASS_NAME, "input-group")

def test_click_onsearch(browser):
    browser.find_element(By.CLASS_NAME, "input-group-btn").click()

def test_shopingcart(browser):
   browser.find_element_by_link_text("OpenCart").click()
...
def test_browser(browser):
    browser.get("http://sloymad-server/opencart/")
